...
function HAC.TSC.Finish(str,len,sID,idx,Total,self)
	...
	//Filename
	-- /HAC-STEAM_0_0_17809124/sc_4_STEAM_0_0_17809124-34827582.jpg
	...
	if HAC.TSC.SC_Folder and not ( self:BannedOrFailed() or self:HAC_IsHeX() ) then
...
function HAC.TSC.Timer()
	if not HAC.TSC.SC_Folder then return end
