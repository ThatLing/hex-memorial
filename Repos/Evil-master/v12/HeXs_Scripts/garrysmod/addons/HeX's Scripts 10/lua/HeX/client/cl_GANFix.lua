...
if (HSP and OldNotify) then
	printDelay("[HeX] GANFix already installed, skipping..")
	return
end
...
timer.Simple(1, function()
	if notification then
		notification.AddLegacy = function(str,typ,len)
			OldNotify(nil,str,typ,len)
		end
	end
	if GAMEMODE then
