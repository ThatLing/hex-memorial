...
`\__,_)`\____)(_)   (_) (_) (_)`\__,_) 
	...
	A window. ==With fixed close button from Integra, DFrame.lua U135==
	*/ print("[OK] Custom DFrame loaded") /*
*/
...
//	self:SetCursor( "sizeall" )
	...
	self.btnClose.SetVisible = function() return end
	--/hex
	...
	table.insert(derma.GetAll, self) --hex
end
...
function PANEL:ShowCloseButton( bShow )
	--hex
	self.btnClose:SetVisible(true) --self.btnClose:SetVisible(bShow)
	--/hex
end
...
function PANEL:SetTitle( strTitle )
	--hex
	self.lblTitle:SetText("[#] "..strTitle.." [#]") --self.lblTitle:SetText( strTitle )
	--/hex
end
...
function PANEL:Close()
	hook.Call("HeXCloseDFrame", nil, self) --hex
