// Written by Syranide, me@syranide.com Fixed By Raklatif :D
...
concommand.Add("+snap2", SnapPress)
concommand.Add("-snap2", SnapRelease)
concommand.Add("snaplock2", SnapLock)
concommand.Add("snaptogglegrid2", SnapToggleGrid)


hook.Add("Initialize", "SmartsnapInitialize2", OnInitialize)

hook.Add("SpawnMenuOpen", "SmartsnapSpawnMenu2", OnSpawnMenu)

hook.Add("Think", "SmartsnapThink2", OnThink)
hook.Add("ShutDown", "SmartsnapShutDown2", OnShutDown)

hook.Add("KeyPress", "SmartsnapKeyPress2", OnKeyPress)
hook.Add("KeyRelease", "SmartsnapKeyRelease2", OnKeyRelease)

hook.Add("CreateMove", "SmartsnapSnap2", OnSnapAim)
hook.Add("CalcView", "SmartsnapSnapView2", OnSnapView)

hook.Add("SpawnMenuOpen", "SmartsnapSpawnMenu2", OnSpawnMenu)

hook.Add("HUDPaintBackground", "SmartsnapPaintHUD2", OnPaintHUD)
