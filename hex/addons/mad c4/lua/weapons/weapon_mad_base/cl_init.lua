...
language.Add("thumper_ammo", "C4 Explosive")					// Thumper				= Explosive Ammo (C4)
...
function SWEP:DrawHUD()
	...
	if (self:GetDTBool(1)) or (cl_crosshair_t:GetBool() == false) or (LocalPlayer():InVehicle()) then return end
