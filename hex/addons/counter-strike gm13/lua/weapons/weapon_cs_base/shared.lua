...
function SWEP:PrimaryAttack()
	...
	if not self.Owner:IsPlayer() or self.Owner:IsNPC() then return end
...
function SWEP:DrawHUD()
	...
	if ( self.Owner == LocalPlayer() && self.Owner:ShouldDrawLocalPlayer() ) then
		...
		tr.mask = 100679695 --( CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_MONSTER|CONTENTS_WINDOW|CONTENTS_DEBRIS|CONTENTS_GRATE|CONTENTS_AUX )
